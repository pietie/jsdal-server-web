...
export class ApplicationComponent {
  ...
  public executionPlugins: any;
  public backgroundThreadPlugins: any;
  public serverMethodPlugins: any;
  ...
  public refreshPluginList() {
    ...
    this.api.app.plugins.getAll(this.projectName, this.dbSource.Name).then(r => {
      ...
      this.executionPlugins = r.filter(p => p.Type == 10);
      this.backgroundThreadPlugins = r.filter(p => p.Type == 20);
      this.serverMethodPlugins = r.filter(p => p.Type == 30);
